 ...
 * this
 *
 * JS 는 Lexical Scope 를 사용하기 때문에 함수의 상위 스코프가 정의 시점에 평가된다.
 ...
 *
 * 1) 일반 함수 호출할 때 this가 최상위 객체 (global 또는 window)를 가르킨다.
 * 2) 메서드로 호출할 때 호출된 객체를 가르킨다.
 * 3) new 키워드를 사용해서 객체를 생성했을 때 객체를 가르킨다.
 */
...
console.log(multiplay.call(yuJin3, 3, 4, 5));
console.log(multiplay.apply(yuJin3, [3, 4, 5]));

/**
 * bind()
 */

const laterFunc = multiplay.bind(yuJin3, 3, 4, 5);
